...
public class Main {
    public static void main(String[] args) {
        ...
        List<Person> people = Arrays.stream(data.trim().split("\n")).map(Main::mapToPerson)
    ...
    private static Person mapToPerson(String list) {
        ...
        return new Person(age, firstName, lastName, email, gender);
    }
}
